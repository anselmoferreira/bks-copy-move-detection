...
disp(['For our Multiscale BKS on uncompressed images we use nt=' int2str(nt)  ' and mry=' num2str(mry) ' for the random forests']);
...
[mean_acc1,mean_tpr1,mean_fpr1,std_acc1,std_tpr1,std_fpr1]=main(nt,mry,'CPHPALL', 1, 2);
...
[mean_acc2,mean_tpr2,mean_fpr2,std_acc2,std_tpr2,std_fpr2]=main(nt,mry,'CPHPALL', 2, 1);
...
[mean_acc3,mean_tpr3,mean_fpr3,std_acc3,std_tpr3,std_fpr3]=main(nt,mry,'CPHPALL', 3, 4);
...
[mean_acc4,mean_tpr4,mean_fpr4,std_acc4,std_tpr4,std_fpr4]=main(nt,mry,'CPHPALL', 4, 3);
...
[mean_acc5,mean_tpr5,mean_fpr5,std_acc5,std_tpr5,std_fpr5]=main(nt,mry,'CPHPALL', 5, 6);
...
[mean_acc6,mean_tpr6,mean_fpr6,std_acc6,std_tpr6,std_fpr6]=main(nt,mry,'CPHPALL', 6, 5);
...
[mean_acc7,mean_tpr7,mean_fpr7,std_acc7,std_tpr7,std_fpr7]=main(nt,mry,'CPHPALL', 7, 8);
...
[mean_acc8,mean_tpr8,mean_fpr8,std_acc8,std_tpr8,std_fpr8]=main(nt,mry,'CPHPALL', 8, 7);
...
[mean_acc9,mean_tpr9,mean_fpr9,std_acc9,std_tpr9,std_fpr9]=main(nt,mry,'CPHPALL', 9, 10);
...
[mean_acc10,mean_tpr10,mean_fpr10,std_acc10,std_tpr10,std_fpr10]=main(nt,mry,'CPHPALL', 10, 9);
...
dlmwrite('results/rf_lvt-CPHPALL-RESULTS.txt',horzcat(nt,mry,mean(vertcat(mean_acc1,mean_acc2,mean_acc3,mean_acc4,mean_acc5,mean_acc6,mean_acc7,mean_acc8,mean_acc9,mean_acc10)), mean(vertcat(mean_tpr1,mean_tpr2,mean_tpr3,mean_tpr4,mean_tpr5,mean_tpr6,mean_tpr7,mean_tpr8,mean_tpr9,mean_tpr10)), mean(vertcat(mean_fpr1,mean_fpr2,mean_fpr3,mean_fpr4,mean_fpr5,mean_fpr6,mean_fpr7,mean_fpr8,mean_fpr9,mean_fpr10)), mean(vertcat(std_acc1,std_acc2,std_acc3,std_acc4,std_acc5,std_acc6,std_acc7,std_acc8,std_acc9,std_acc10)), mean(vertcat(std_tpr1,std_tpr2,std_tpr3,std_tpr4,std_tpr5,std_tpr6,std_tpr7,std_tpr8,std_tpr9,std_tpr10)), mean(vertcat(std_fpr1,std_fpr2,std_fpr3,std_fpr4,std_fpr5,std_fpr6,std_fpr7,std_fpr8,std_fpr9,std_fpr10))),'-append');

%Now we write the 10 mean accuracies, 10 mean false positive rates and 10 mean false positive rates 
dlmwrite('results/rf_lvt-CPHPALL-RESULTS-10-ACC.txt',horzcat(nt,mry,mean_acc1,mean_acc2,mean_acc3,mean_acc4,mean_acc5,mean_acc6,mean_acc7,mean_acc8,mean_acc9,mean_acc10), '-append');
dlmwrite('results/rf_lvt-CPHPALL-RESULTS-10-FPR.txt',horzcat(nt,mry,mean_fpr1,mean_fpr2,mean_fpr3,mean_fpr4,mean_fpr5,mean_fpr6,mean_fpr7,mean_fpr8,mean_fpr9,mean_fpr10), '-append');
dlmwrite('results/rf_lvt-CPHPALL-RESULTS-10-TPR.txt',horzcat(nt,mry,mean_tpr1,mean_tpr2,mean_tpr3,mean_tpr4,mean_tpr5,mean_tpr6,mean_tpr7,mean_tpr8,mean_tpr9,mean_tpr10), '-append');
